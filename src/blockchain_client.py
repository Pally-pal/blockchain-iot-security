...
class BlockchainClient:
    ...
    def register_data_hash(self, data_hash: str, device_id: str) -> Dict:
        """
        ...
        try:
            ...
            # Check if hash already exists on blockchain (avoids duplicates)
            try:
            ...
            if 'insufficient funds' in error_msg.lower():
                user_msg = "Account has insufficient balance. Please ensure your account has enough ETH."
                ...
                user_msg = "Failed to connect to blockchain. Check your ALCHEMY_URL."
            else:
        ...
        try:
            ...
            for i in range(total_records):
                try:
                    ...
                    # record = (dataHash, deviceAddress, timestamp, deviceId, exists)
                    if record[4] and record[3] == device_id:
